...
class RunMapView extends StatefulWidget {
  ...
  @override
  State<RunMapView> createState() => RunMapViewState();
}


class RunMapViewState extends State<RunMapView> {
  ...
  //  root center function for summery page
